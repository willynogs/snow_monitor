...
module.exports = function(groups){
    ...
    var url = `https://${sn.instance}.service-now.com/api/now/table/task?sysparm_query=${str}^active=true^sys_class_name!=sysapproval_group^sys_class_name=change_request&sysparm_display_value=all`;
